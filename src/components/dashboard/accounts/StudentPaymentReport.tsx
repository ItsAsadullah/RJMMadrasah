        ...
        >
            <div className="flex-1 flex flex-col">
                ...
                <div className="text-center pb-4 border-b-2 border-emerald-700 mb-6">
                    ...
                    <p className="text-[12px] text-gray-700 font-medium">{getBranchAddress(student?.branch_id, student?.branches)}</p>
                    <p className="text-[10px] text-gray-500 mt-1">মোবাইল: {toBengaliNumber(getBranchPhone(student?.branch_id, student?.branches))}</p>
